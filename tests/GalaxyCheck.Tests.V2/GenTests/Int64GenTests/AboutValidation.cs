    ...
    public class AboutValidation
    {
        ...
        public NebulaCheck.IGen<Test> ItErrorsWhenMinimumIsGreaterThanMaximum() =>
            ...
            select Property.ForThese(() =>
            {
                ...
                action.Should()
                    ...
                    .WithMessage("Error while running generator Int64Gen: 'min' cannot be greater than 'max'");
            });
        ...
        public NebulaCheck.IGen<Test> ItErrorsWhenMinimumIsGreaterThanOrigin() =>
            ...
            select Property.ForThese(() =>
            {
                ...
                action.Should()
                    .Throw<GalaxyCheck.Exceptions.GenErrorException>()
                    .WithMessage("Error while running generator Int64Gen: 'origin' must be between 'min' and 'max'");
            });
