...
namespace GalaxyCheck
{
    public static partial class Extensions
    {
        ...
        public static PropertyAsync<T> ForAllAsync<T>(this IGen<T> gen, Func<T, Task<bool>> func) => Property.ForAllAsync(gen, func);
        ...
        /// <returns></returns>
        public static PropertyAsync<T> ForAllAsync<T>(this IGen<T> gen, Func<T, Task> action) => Property.ForAllAsync(gen, action);
    }
}
