...
namespace GalaxyCheck
{
    public partial class Property
    {
        ...
        public static Property<T0> ForAll<T0>(IGen<T0> gen0, Action<T0> func, int? arity = null) =>
            ForAll(gen0, func.AsTrueFunc(), arity);

        public static Property<(T0, T1)> ForAll<T0, T1>(
            IGen<T0> gen0,
            IGen<T1> gen1,
            Action<T0, T1> func) => ForAll(gen0, gen1, func.AsTrueFunc());

        public static Property<(T0, T1, T2)> ForAll<T0, T1, T2>(
            IGen<T0> gen0,
            IGen<T1> gen1,
            IGen<T2> gen2,
            Action<T0, T1, T2> func) => ForAll(gen0, gen1, gen2, func.AsTrueFunc());
        ...
        public static Property<(T0, T1, T2, T3)> ForAll<T0, T1, T2, T3>(
            ...
            IGen<T2> gen2,
            IGen<T3> gen3,
            Action<T0, T1, T2, T3> func) => ForAll(gen0, gen1, gen2, gen3, func.AsTrueFunc());
    }
}
